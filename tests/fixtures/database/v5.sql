-- SQLite schema at Alembic revision 0005, before location tracking.
...
INSERT INTO activities (id, public_id, start_time, end_time)
VALUES (1, '00000000000000000000000000000005', '2024-05-01 08:00:00', '2024-05-01 08:30:00');
...
INSERT INTO activity_uploads (
    id, activity_id, provider, status, uploaded_at, updated_at,
    provider_activity_id, payload_hash, last_error
)
VALUES (
    1, 1, 'intervals_icu', 'ok', '2024-05-01 09:00:00', '2024-05-01 09:00:00',
    'provider-v5-1', 'hash-v5-1', NULL
);
...
VALUES (
    1, 1, 1, '2024-05-01 08:00:00', '2024-05-01 08:30:00', 1800,
    5000.0, 2.8, 140.0, 160, 0.0,
    172.0, 240.0, 100.0, 90.0, '2024-05-01 09:00:00'
);
