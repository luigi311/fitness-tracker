-- SQLite schema shipped by v4.0.0, v4.0.1, and v4.1.0.
-- v4 did not introduce a database layout change after v3; it remains a
-- separate fixture because it was an externally shipped migration starting
-- point.
...
VALUES (1, '2024-04-01 08:00:00', '2024-04-01 08:30:00');
...
VALUES (
    1, 1, 'intervals_icu', 'ok', '2024-04-01 09:00:00',
    'provider-v4-1', 'hash-v4-1', NULL
);
...
VALUES (
    1, 1, 1, '2024-04-01 08:00:00', '2024-04-01 08:30:00', 1800,
    5000.0, 2.8, 140.0, 160, 0.0,
    172.0, 240.0, 100.0, 90.0, '2024-04-01 09:00:00'
);
