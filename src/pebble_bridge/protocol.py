...
KEY_ELAPSED: Final = 14
KEY_WORKOUT_STEP_COUNT: Final = 15
KEY_STEP_REMAINING: Final = 16
KEY_STEP_REMAINING_KIND: Final = 17
...
KEY_ELAPSED_SCALE: Final = 1
KEY_WORKOUT_STEP_COUNT_SCALE: Final = 1
KEY_STEP_REMAINING_SCALE: Final = 1
KEY_STEP_REMAINING_KIND_SCALE: Final = 1
...
KEY_WIDTHS: Final = {
    ...
    KEY_SYNC_REQUEST: 8,
    KEY_ELAPSED: 32,
    KEY_WORKOUT_STEP_COUNT: 16,
    KEY_STEP_REMAINING: 32,
    KEY_STEP_REMAINING_KIND: 8,
}
...
KEY_SCALES: Final = {
    ...
    KEY_SYNC_REQUEST: 1,
    KEY_ELAPSED: 1,
    KEY_WORKOUT_STEP_COUNT: 1,
    KEY_STEP_REMAINING: 1,
    KEY_STEP_REMAINING_KIND: 1,
}
