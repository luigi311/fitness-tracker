...
class TrainerController:
    ...
    def __init__(
        ...
        *,
        ...
        self.pending_target: int | float | None = None
        self.target_mode: TrainerMode | None = None
        self.erg_retry_task: Future | None = None
        self.erg_applied_target: int | float | None = None
    ...
    async def _retry_loop(self, target_mode: TrainerMode) -> None:
        ...
        while True:
            ...
            if self.erg_disabled and target_mode is TrainerMode.POWER:
    ...
    def update_erg_safeguard(self, timestamp_ms: int, power_watts: int | None) -> None:
        ...
        if self.target_mode is not TrainerMode.POWER and self.sport_type != SportTypesEnum.biking:
            return
